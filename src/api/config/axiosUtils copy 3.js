...
export function request(path) {
  return {
    get(id) {
      if (id) return { url: `${domain + path}/${id}`, method: 'get' };
      return { url: `${domain + path}`, method: 'get' };
    },
    post(data) {
      return { url: `${domain + path}`, method: 'post', data };
    },
    edit(id, data) {
      return { url: `${domain + path}/${id}`, method: 'put', data };
    },
    delete(id) {
      return { url: `${domain + path}/${id}`, method: 'delete' };
    },
  };
}
